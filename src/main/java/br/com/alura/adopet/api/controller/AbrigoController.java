...
import br.com.alura.adopet.api.dto.CadatrarPetDto;
...
public class AbrigoController {
  ...
  private PetService petService;
    ...
    @Transactional
    public ResponseEntity<String> cadastrarPet(@PathVariable String idOuNome, @RequestBody @Valid CadatrarPetDto pet) {
        try{
